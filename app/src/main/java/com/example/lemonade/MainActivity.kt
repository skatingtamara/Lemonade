...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        // Calling the function to set the view elements for the UI to reflect the correct state
        setViewElements()
    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            SELECT -> {
                ...
                lemonImage?.setImageResource(R.drawable.lemon_tree) //@tamara what is a safe call??
            }
            SQUEEZE -> {
                textAction.setText(R.string.lemon_squeeze)
                lemonImage?.setImageResource(R.drawable.lemon_squeeze) //@tamara what is a safe call??
            }
            DRINK -> {
                textAction.setText(R.string.lemon_drink)
                lemonImage?.setImageResource(R.drawable.lemon_drink) //@tamara what is a safe call??
            }
            RESTART -> {
                textAction.setText(R.string.lemon_empty_glass)
                lemonImage?.setImageResource(R.drawable.lemon_restart) //@tamara what is a safe call??
            }
        }
